...
[cVal,dVal] = dataInterp(cmunkdeep,depmatdeep);
...
bSpace = interp1(depmatdeep(:,1),depmatdeep(:,2), rSpace, 'linear', 'extrap');
...
figure(raytraceFig)
plot(depmatdeep(:,1)/1000,depmatdeep(:,2),'color',1/255*[194 178 128]);
