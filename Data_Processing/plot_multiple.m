...
load 'D:\Documents\Thesis_Research\Extended_Kalman_Filter\0_10.mat'
...
plot(1:length(dir1),dir1,'g',1:length(dir6),dir6,'--m')
ylabel('Direction (degrees)')
axis([1 length(dir1) -180 180])
legend('Magnitude (0 bias)', 'Magnitude (10 degree bias)', 'Direction (0 bias)','Direction (10 degree bias)')
...
legend('No bias','10 degree bias','Actual position','location','southeast')
